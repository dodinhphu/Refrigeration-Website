            ...
            if (D == 'check') {
                if (!C.userlockRatio && E.getCustomData('isReady') == 'true') {
                    ...
                    if (!F && !G) C.lockRatio = true;
                        ...
                        if (Math.round(H) == Math.round(I)) C.lockRatio = true;
                }
                ...
                elements: [{
                    ...
                    children: [{
                            ...
                            children: [{
                                ...
                                commit: function (C, D, E) {
                                    ...
                                    if (C == d || C == f) {
                                        ...
                                        else D.removeStyle('float'); if (!E && C == d) {
                        ...
                        children: [{
                            ...
                            id: 'htmlPreview',
                            style: 'width:95%;',
                            html: '<div>' + CKEDITOR.tools.htmlEncode(b.lang.common.preview) + '<br>' + '<div id="' + y + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div>' + '<div id="' + z + '" class="ImagePreviewBox"><table><tr><td>' + '<a href="javascript:void(0)" target="_blank" onclick="return false;" id="' + A + '">' + '<img id="' + B + '" alt="" /></a>' + (b.config.image_previewText || '<span style="font:bold 14px Arial;color:#55aa00">Nghĩa</span>: khách hàng không chỉ đơn thuần là khách hàng, khách hàng còn là bạn bè. Đó là phương châm làm việc của chúng tôi. Chúng tôi luôn nỗ lực hết mình để tạo ra những sản phẩm tốt nhất cho những người bạn của mình. Đến với TAT THANH JSC, bạn sẽ nhận được những lời chào mừng nồng nhiệt, được chia sẻ để rồi cùng nhau tìm kiếm những điểm chung.<br/><br/><span style="font:bold 14px Arial;color:#55aa00">Tín</span>: đảm bảo chữ Tín là một nguyên tắc làm việc của mọi doanh nghiệp. Chỉ có đảm bảo uy tín thì doanh nghiệp mới có thể tồn tại và phát triển. Chúng tôi luôn nỗ lực hết mình để đảm bảo uy tín trong quá trình làm việc với khách hàng.<br/><br/><span style="font:bold 14px Arial;color:#55aa00">Lợi</span>: Sản phẩm đem lại lợi nhuận cho khách hàng là một sản phẩm tốt. Chúng tôi không ngừng hoàn thiện quy trình, nâng cao trình độ và khả năng sáng tạo để tạo ra những sản phẩm tốt nhất cho khách hàng của mình.') + '</td></tr></table></div></div>'
                        }]
                    }]
                }]
            }, {
