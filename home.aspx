    ...
    <footer class="bg-dark text-center text-white footer_css">
        ...
        <div class="container p-4">
            ...
            <section class="mb-4">
                ...
                <div class="all_address_f" style="display:inline-block">
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 1:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi1" runat="server"></asp:Literal></h6>
                    </div>
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 2:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi2" runat="server"></asp:Literal></h6>
                    </div>
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 3:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi3" runat="server"></asp:Literal></h6>
                    </div>
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 4:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi4" runat="server"></asp:Literal></h6>
                    </div>
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 5:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi5" runat="server"></asp:Literal></h6>
                    </div>
                    <div class="item_address_f" >
                        <h6 class="tddc">
                            <i class="icon_address fas fa-map-marker-alt"></i>Cơ Sở 6:
                        </h6>
                        <h6 class="address_f">&ensp;<asp:Literal ID="f_diachi6" runat="server"></asp:Literal></h6>
                    </div>
                </div>
        ...
        <!-- Copyright -->
        <div class="dinhphu text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2021 Copyright:
